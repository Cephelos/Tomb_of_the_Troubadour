...
public class PLayerSword : MonoBehaviour
{
    ...
    public GameObject sword_area;
    [SerializeField] public float timeSinceAttack;

    void Update()
    {
        Renderer rend = sword_area.transform.GetComponent<Renderer>();
        Color matColor = rend.material.color;
        float a_value = rend.material.color.a;
        BoxCollider2D sword_Collider = sword_area.GetComponent<BoxCollider2D>();
    ...
    public virtual void Attack(Platformer.Mechanics.PlayerMovement playerMovement)
    {
        ...
        sword_area.transform.position =spawnPos;
